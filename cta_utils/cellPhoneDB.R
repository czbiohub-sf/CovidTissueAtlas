...
# Runs cellphone DB for all cell types in the object 
runCellPhone <- function(tissue = "liver"){
		...
		# Re-normalize data
		obj_list[[p]] = NormalizeData(obj_list[[p]], normalization.method = "RC") 
...
selectColumns_cpdb <- function(tissue = 'liver', this_condition = "Control"){ 
...
# NOW we can run  CPDB visualization
